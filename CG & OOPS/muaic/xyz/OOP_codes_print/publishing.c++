/*
Imagine a publishing company which does marketing for book and audiocassette versions. Create a class publication that stores the title (a string)
and price (type float) of a publication.From this class derive two classes: book, which adds a page count(type int),
...
class book:public publication
{
    ...
    public:
     void addpl(){
         add();
         try{
            cout<<"Enter page count of publication : "<<endl;
            cin>>pg_cnt;
            if(pg_cnt<=0)
            {
                throw pg_cnt;
...
class tape:public publication
{
  ...
  public:
    void addtpl()  
    {
        add();
        try{
            cout<<"Enter the playtime of cassette : "<<endl;
            cin>>play_time;
            if(play_time<=0)
            {
                throw play_time;
    ...
    {
        display();
        cout<<"Play time of the cassette is : "<<play_time<<endl;
    }
};
